...
class ArbolAVL:
    ...
    def rotacion_simple_derecha(self, nodo):
        ...
        nodo.altura = max(self.altura(nodo.izquierda),
                          self.altura(nodo.derecha)) + 1
        nueva_raiz.altura = max(self.altura(
            nueva_raiz.izquierda), self.altura(nueva_raiz.derecha)) + 1
        return nueva_raiz
    ...
    def insertar(self, raiz, valor):
        ...
        raiz.altura = max(self.altura(raiz.izquierda),
                          self.altura(raiz.derecha)) + 1
